...
import pic from "../../../../public/data.jpg";
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className='lg:min-h-[200vh] min-h-[110vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50'
    >
      <motion.h2
        style={{
        ...
        className='dark:text-white text-neutral-800 lg:text-6xl text-3xl font-bold mb-20 text-center'
      >
        {title || (
          <span>
            Unleashing Data&apos;s Potential with <br /> AI Precision!
          </span>
        )}
      </motion.h2>
      {/* Lid */}
      ...
      />
      {/* Base area */}
      <div className='h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#373739] rounded-2xl overflow-hidden relative -z-10'>
        {/* above keyboard bar */}
  ...
  return (
    <div className='relative [perspective:800px]'>
      <div
        ...
        className='h-[12rem] w-[32rem] bg-[#c9f58d] rounded-2xl p-2 relative'
      >
        <div
          style={{
        ...
        >
          <span className='text-primary'>Quanta AI</span>
        </div>
      </div>
      <motion.div
        style={{
